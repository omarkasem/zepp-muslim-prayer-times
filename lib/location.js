...
// Ask the side-service for a fresh location, persist it, and reschedule the
// reminders. Returns the location on success or null on failure. `requestFn` is
// the page's `this.request` (ZML) so this stays @zos/ui-free and reusable.
